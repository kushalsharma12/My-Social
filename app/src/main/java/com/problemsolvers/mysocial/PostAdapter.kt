...
class PostAdapter(options: FirestoreRecyclerOptions<Post>, val listener: IPostAdapter) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PostViewHolder {
        ...
        viewHolder.likeButton.setOnClickListener {
            ...
            // here snap shot is used to get the post id
            // snapshot hmaara firestoreRecycler me he hota hai!
        }
        return viewHolder
    }
    ...
    override fun onBindViewHolder(holder: PostViewHolder, position: Int, model: Post) {
        ...
        if (isLiked) { holder.likeButton.setImageDrawable(ContextCompat.getDrawable(holder.likeButton.context, R.drawable.ic_like
                )
            )
        } else { holder.likeButton.setImageDrawable(ContextCompat.getDrawable(holder.likeButton.context,R.drawable.ic_unlike
                )
            )
        }
